      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
            We're a passionate group of students dedicated to advancing electric-solar vehicle technology while gaining
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16">
          <div>
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4 sm:mb-6 leading-relaxed">
              Our Solar Car Team combines engineering excellence with environmental consciousness. We design and build
              high-performance electric-solar vehicles that compete in national competitions while advancing sustainable
              transportation technology.
            </p>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              From aerodynamic design to solar panel optimization, our students work on every aspect of vehicle
              development, gaining invaluable experience in mechanical engineering, electrical systems, project
