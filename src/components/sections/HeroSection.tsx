    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-5xl lg:text-7xl mb-4 sm:mb-6">
            Racing Towards a 
          ...
          <p className="text-base sm:text-xl text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
            We design, build, and race solar-powered vehicles while learning cutting-edge 
            engineering skills and promoting renewable energy innovation.
          </p>
